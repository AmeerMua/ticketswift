...
export default function EventDetailsPage() {
  ...
  const eventRef = useMemoFirebase(
    () => (firestore ? doc(firestore, 'events', EVENT_ID) : null),
    [firestore]
  );
  ...
  // This check is to satisfy TypeScript since event could be null.
  // The `notFound()` call above handles the case where it actually is null.
  if (!event) {
    return null;
  }
